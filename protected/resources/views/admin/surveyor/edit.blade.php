...
{!! Form::model($surveyor, [ 'method' => 'PUT','id' => 'ubahsurveyor','class' => 'form-horizontal','role' => 'form']) !!}

  {!! Form::hidden('id', null, ['class' => 'form-control', 'placeholder' => 'Id Topik', 'id' => 'id']) !!}


                         <div class="form-group">
                            {!! Form::label('nama', 'Nip',['class' => 'col-md-3 control-label']) !!}
                            <div class="col-md-8">
                          ...
                          <div class="form-group">
                            {!! Form::label('nama', 'Telp',['class' => 'col-md-3 control-label']) !!}
                            <div class="col-md-8">
